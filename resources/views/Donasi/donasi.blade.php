        ...
        <div class="col-md-12">
            ...
            <div class="js-wizard-simple block">
                ...
                <ul class="nav nav-tabs nav-tabs-alt nav-fill" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" onclick="check()" href="#wizard-progress2-step1" data-toggle="tab">Step 1</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" onclick="check()" href="#wizard-progress2-step2" data-toggle="tab">Step 2</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" onclick="check()" href="#wizard-progress2-step3" data-toggle="tab">Step 3</a>
                    </li>
                </ul>
                {{--  <!-- END Step Tabs -->  --}}
                    ...
                    <div class="block-content block-content-sm block-content-full bg-body-light">
                        <div class="row">
                            ...
                            <div class="col-6 text-right">
                                ...
                                <button type="submit" class="btn btn-alt-primary d-none" data-toggle="modal" data-target="#modal-popout" data-wizard="finish" >
