                ...
                <div id="sidebar-scroll">
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                <li>
                                    <a href="be_pages_dashboard.html"><i class="fa fa-coffee"></i><span class="sidebar-mini-hide">Dashboard</span></a>
                                </li>
                                <li>
                                    <a href="be_pages_dashboard.html"><i class="fa fa-file-text-o"></i><span class="sidebar-mini-hide">Posts</span></a>
                                </li>
                                <li>
                                    <a href="be_pages_dashboard.html"><i class="fa fa-photo"></i><span class="sidebar-mini-hide">Medias</span></a>
                                </li>
                                <li>
                                    <a href="be_pages_dashboard.html"><i class="si si-bubbles"></i><span class="sidebar-mini-hide">Comments</span></a>
                                </li>
                                <li>
                                    <a href="be_pages_dashboard.html"><i class="si si-users"></i><span class="sidebar-mini-hide">Users</span></a>
                                </li>
                                <li>
                                    <a href="be_pages_dashboard.html"><i class="fa fa-money"></i><span class="sidebar-mini-hide">Donations</span></a>
                                </li>
                            </ul>
                        </div>
                        <!-- END Side Navigation -->
                        ...
                        <div class="col-6 col-xl-3">
                            <a class="block block-rounded block-bordered block-link-shadow" href="javascript:void(0)">
                                <div class="block-content block-content-full clearfix">
                                    ...
                                    <div class="font-size-h3 font-w600 text-earth">Rp. <span data-toggle="countTo" data-speed="1000" data-to="4252000">0</span></div>
                                ...
                                <div class="block-content">
                                    <div class="row items-push text-center">
                                        <div class="col-6 col-sm-4">
                                            ...
                                            <div class="font-size-h4 font-w600">Rp. 720.000</div>
                                        ...
                                        <div class="col-6 col-sm-4">
                                            ...
                                            <div class="font-size-h4 font-w600">Rp. 160.000</div>
                                        ...
                                        <div class="col-12 col-sm-4">
                                            ...
                                            <div class="font-size-h4 font-w600">Rp. 24.300</div>
